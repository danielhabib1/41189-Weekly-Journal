...
Through the process of reflection, I have gained a deepened insight into the emergence and complexity of behaviour. The first topic in this workshop was segregation and peer effects. Ultimately, through this week I have learnt about the inherit characteristic of human beings to adapt their habits and behaviours to those they associate themselves with, a phenomenon referred to as homophily. In building on this topic, the Schelling’s Segregation Model is a tool used to study the division of demographic groups within society into separate communities. Additionally, the concept of peer effects, more specifically the example of the standing ovation provided a new way of viewing aspects of human behaviour which was previously ignored. Ultimately, this insight enables me to deconstruct factors that influence particular human behaviours in order to gain a deepened understanding. Further, I have been able to grasp the complexity of culture in influencing human behaviours. Finally, through reflecting upon replicator dynamics, it has been observed that within the population, evolution can occur through interactions.

•	What are (my/the) perceived strengths and weaknesses that I have observed?

In reflecting upon this week, as my team works further on the assessment, I have observed strengths and weaknesses that I possess in a team-based situation. Whilst previously it had been noted that my authoritative mindset created dilemmas. However, within this week, my greatest weaknesses stemmed from an inadequate allocation of time to the assessment. Throughout week 7, my focus on coordinating the components allocated to other team members, I began to neglect my own part. However, my perceived strength specifically in this week was the development of a structured timetable which provided group direction as to when we could part take in group calls. In order to do this effectively, I took the time to note scheduling differences to ensure that we would all be available at those specific periods. 

•	What were the challenges I have encountered/observed and how well (did I/my team) handle them?

Through reflecting upon the challenges experienced through this week, it can be noted that those challenges encountered last week, were still of major concern in this week. More specifically, it became more apparent that a divide existed within our group, which presented various obstacles. In searching through the shared planning and report document, it was noticeable that a few members in the group had not devised any ideas or commenced their delegated part. This is a greater challenge than last week as the due date is in week 8. Further, as this week is a vacation, it becomes more difficult to organise meetings, particularly as our regular workshop was not taking place. In response to this challenge, I sent multiple messages to the group in which I received a reply from the same team member. Therefore, more extreme actions had to be taken through a formal message to the head of the subject, in order to address the team’s lack of coherence before it got too late. Ultimately, the process of realigning the group focus in still underway.
...
Upon thorough reflection of this week’s workshop, I have gained many new insights about the topic of complexity and emergent behaviour, as well as deepened my understanding of last week’s concepts. More specifically, various game theories including competition, cooperation and strategy are extremely relevant and applicable topics within everyday life. These notions are supported through various models such as the Colonel Blotto model as well as the Prisoners Dilemma model. The Colonel Blotto model is a game which results in one winner and one loser. With real life situations, the applicability of this model can be seen in sports games, elections or hiring applicants. Within these scenario’s, it is about applying the best strategy and allocating the correct amount of resources to be the ‘winner’.  However, the prisoner’s dilemma model is based around the idea of incentives and cooperation. Ultimately, in this type of situation, the players rely on each other’s actions to form an equilibrium point where they achieve a mutually optimal outcome. Examples of this includes price-competition, technological adoption or political campaigns, each of which relying upon weighing up actions to ensure the outcome is advantageous. Therefore, in this week’s teaching’s I have gained new insights when looking at strategy and cooperation and have been introduced to the Colonel Blotto and Prisoner’s Dilemma model’s which I hadn’t heard of previously.

•	What are (my/the) perceived strengths and weaknesses that I have observed?

In reflecting upon this week, I have been able to observe various strengths and weaknesses. Within this week, the pre-submission of the final report was due, and the greatest challenge was coverting the report to a Jupyter notebook in GitHub, both of which being new platforms. Within the process, my strength was taking as much time as necessary to completely familiarise myself with these applications, to ensure that when submitting the report, there were no technical issues or other problems that couldn’t be resolved. Another strength which I noticed was my ability to apply the Colonel Blotto and Prisoner’s Dilemma models to everyday life. However, a weakness that I have identified through reflection was my impatience when the report was not being completed in a timely manner. Being the week of submission, I found myself becoming impatient when members in the group had not started the project. I noticed this created a divide in the group and led to less communication and coherence.
